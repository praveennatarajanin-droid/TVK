...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const uiTranslations = {
    en: {
      ...
      read_more: "Read More",
      about_title: "Primary Leader of Tamil Nadu",
      about_badge: "TVK President & CM Office",
      about_intro: "Dedicated to secular social justice, welfare of Tamil people, and corrupt-free transparent governance under the leadership of CM Thalapathy Vijay.",
      about_minister_label: "CM Portfolio",
      highlight_1_title: "CM Office (CMO)",
      highlight_1_desc: "Directing administrative reforms, file tracking, and public grievances.",
      highlight_2_title: "Hon'ble CM Vijay",
      highlight_2_desc: "Serving 8 Crore+ residents with state-wide transparency.",
      highlight_3_title: "Welfare Schemes",
      highlight_3_desc: "Distributing educational aid, health support, and job skills.",
      highlight_4_title: "Active Redressal",
      highlight_4_desc: "Resolving civic problems swiftly through digital channels.",
      gallery_title: "Media Gallery",
      videos_title: "Video Feeds",
      projects_title: "TVK Welfare Projects",
      projects_subtitle: "Tracking key development works in the State",
      ...
      grievance_title: "Reach Your Chief Minister",
      grievance_subtitle: "Submit your local issues directly to Hon'ble CM Thalapathy Vijay's desk.",
      grievance_intro: "Are you facing issues with public infrastructure, school facilities, drinking water, or drainage? Fill out the petition below. The Chief Minister's Grievance Cell will review and take prompt action within 15 working days.",
      ...
      form_ward: "Select Constituency District/Ward",
      form_type: "Select Issue Category",
      form_desc: "Detailed Description of Grievance",
      form_desc_placeholder: "Describe your issue, including landmarks and location details...",
      form_submit: "Submit Petition",
      form_submitting: "Submitting...",
      form_success: "Thank you! Your petition has been submitted successfully to CM cell. Tracking ID: ",
      form_error: "Please fill in all required fields accurately.",
      footer_about_desc: "Official public interaction portal for Thalapathy Vijay, TVK Founder-President & Hon'ble Chief Minister of Tamil Nadu.",
      footer_links_title: "Quick Navigation",
      footer_contact_title: "TVK Head Office Address",
    ...
    ta: {
      ...
      highlight_1_desc: "அரசு நிர்வாக சீர்திருத்தங்கள், நேரடி மனு கண்காணிப்பு மற்றும் மக்கள் சேவைகளை வழிநடத்துதல்.",
      highlight_2_title: "மாண்புமிகு முதல்வர் விஜய்",
      highlight_2_desc: "8 கோடி தமிழக மக்களின் முன்னேற்றத்திற்கும் சமத்துவத்திற்குமான நேர்மைப் பாதை.",
      highlight_3_title: "நலத்திட்ட உதவிகள்",
      highlight_3_desc: "கல்வி உதவித்தொகை, மருத்துவ உதவிகள் மற்றும் தொழில் திறன் பயிற்சிகள் வழங்குதல்.",
      ...
      proj_location: "இடம்",
      grievance_title: "உங்கள் முதல்வரிடம் மனு கொடுங்கள்",
      grievance_subtitle: "உங்கள் வார்டு மற்றும் பகுதி பிரச்சனைகளை நேரடியாக முதலமைச்சர் தளபதி விஜய் அவர்களின் கவனத்திற்கு கொண்டு செல்லுங்கள்.",
      grievance_intro: "உங்கள் பகுதியில் குடிநீர் தட்டுப்பாடு, பொது சுகாதாரம், பள்ளி கட்டமைப்பு, அல்லது இதர குறைகள் இருந்தால் கீழே உள்ள படிவத்தில் மனுவை சமர்ப்பிக்கவும். முதல்வர் அலுவலகம் 15 நாட்களுக்குள் நடவடிக்கை எடுக்கும்.",
      ...
      form_ward: "உங்களது மாவட்டம் / வார்டை தேர்வு செய்க",
      ...
      form_success: "நன்றி! உங்கள் மனு வெற்றிகரமாக முதல்வர் அலுவலகத்திற்கு சமர்ப்பிக்கப்பட்டது. மனு எண்: ",
  ...
  const updateLanguageUI = () => {
    ...
    if (elements.headerMlaTitle) elements.headerMlaTitle.textContent = currentLang === "en" ? "Chief Minister of TN" : "தமிழக முதலமைச்சர்";
